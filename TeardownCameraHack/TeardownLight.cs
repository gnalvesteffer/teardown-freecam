...
namespace TeardownCameraHack
{
    public class TeardownLight
    {
        ...
        {
            get => Reader.Default.Read<float>(_pointer + 0x30, out _);
            set => Writer.Default.Write(_pointer + 0x30, value);
        }

        public float PositionY
        {
            get => Reader.Default.Read<float>(_pointer + 0x34, out _);
            set => Writer.Default.Write(_pointer + 0x34, value);
        }

        public float PositionZ
        {
            get => Reader.Default.Read<float>(_pointer + 0x38, out _);
            set => Writer.Default.Write(_pointer + 0x38, value);
        }
